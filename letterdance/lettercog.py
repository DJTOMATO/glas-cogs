...
class LetterCog(commands.Cog):
    ...
    async def letterdance(self, ctx, *, Phrase: commands.clean_content(fix_channel_mentions=False, use_nicknames=True, escape_markdown=False, remove_markdown=False) = None):
        """
    ...
    def clean(self, message):
        ...
        filtered_string = ''.join(char.lower() for char in message if char.lower() in allowed_characters)
